...
const FALLBACK_SEEDS: EntitySeed[] = [
  ...
  { label: "Legacy Data Modernization", aliases: ["legacy datalake", "datalake modernization", "amc datalake", "data lake modernization"], kind: "project" },
  { label: "OLAP Workload Architecture", aliases: ["olap", "olap workload", "workload architecture", "workload-specific architecture"], kind: "project" },
  { label: "ML-Driven Allocation Engine", aliases: ["brain mvp", "brain", "allocation engine", "ml allocation"], kind: "project" },
  { label: "Automated Web Intelligence Pipeline", aliases: ["intelligence pipeline", "web intelligence", "automated intelligence"], kind: "project" },
  { label: "Financial Technology ML Platform", aliases: ["fintech ml", "financial technology client", "streaming ml"], kind: "project" },
