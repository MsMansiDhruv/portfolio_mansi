...
export const OLAP_CASE_STUDY = {
  ...
  final: {
    ...
    line2: ["It's about matching each workload to the system best suited to serve it."],
    supporting:
      "The production migration showed that performance, cost, and operational fit depend on access patterns — not the database in isolation.",
  },

  takeaway:
    "The production migration showed that performance, cost, and operational fit depend on access patterns — not the database in isolation. Architecture isn't about choosing the best database — it's about matching each workload to the system best suited to serve it.",
