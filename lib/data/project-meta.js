...
export const PROJECT_META = {
  ...
  "automated-intelligence-pipeline": {
    ...
    purpose:
      "Build an automated pipeline to discover, extract, process, and surface business-relevant company announcements from distributed web sources.",
    ...
    problem:
      "Relevant company announcements were spread across newsroom pages and feeds; manual monitoring, extraction, and deduplication did not scale.",
