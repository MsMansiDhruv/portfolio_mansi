...
export const PROJECT_META = {
  "project-amc-datalake-solution": {
    ...
    relatedSlugs: ["olap-workload-architecture", "gpu-bench", "small-data-lake"],
  },
  ...
  "olap-workload-architecture": {
    ...
    purpose:
      "Architecture PoC: separate analytical and operational workloads after Redshift cost signal from high-frequency XIRR serving.",
    ...
    summary:
      "Investigation triggered by ~60K/day point-lookups on Redshift Serverless — benchmarked engines and landed on workload separation, not a single-database winner.",
    problem:
