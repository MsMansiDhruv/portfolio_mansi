...
export const PROJECT_META = {
  "project-amc-datalake-solution": {
    ...
    purpose: "Modernizing legacy ETL and analytics infrastructure for a leading mutual fund provider.",
    desc: "Cloud-native data lake, Glue ETL, and Redshift analytics for a leading Indian AMC",
    timeline: "~28 weeks (delivery plan)",
