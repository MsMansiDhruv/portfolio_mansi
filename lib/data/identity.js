...
export const CONTACT_VOICE = {
  title: "Get in touch",
  description: "Have a messy data problem? Those are usually the interesting ones.",
  followUp: "Questions about work, speaking, or collaboration—I aim to reply within a few business days.",
};

/** Slugs for experiments / personal builds — real data from projects.js */
