...
export const IDENTITY = {
  ...
  givenName: "Mansi",
  role: CURRENT_ROLE,
  domains: "Data Platforms · Cloud Architecture",
  headline: `${CURRENT_ROLE} · Data Platforms · Cloud Architecture`,
  statement: "I build reliable data platforms—from raw inputs to decisions teams can trust.",
  mapSupport: "The AI power map — the physical terrain of the platforms I build.",
};
