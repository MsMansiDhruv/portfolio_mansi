...
/** One positioning line for every public surface. */
export const IDENTITY = {
  name: "Mansi Dhruv",
  givenName: "Mansi",
  role: CURRENT_ROLE,
  domains: "Data Platforms · Cloud Architecture · ETL Modernization",
  headline: `${CURRENT_ROLE} · Data Platforms · Cloud Architecture · ETL Modernization`,
  statement: "I build reliable data platforms—from raw inputs to decisions teams can trust.",
  mapSupport: "Industry context — global data-centre electricity and U.S. share (IEA / ATLAS), not personal impact.",
};
...
export const ASK_MANSI = {
  title: "Ask Mansi",
  lead: "Explore my work, architecture decisions, and engineering experience.",
  description:
    "Ask about projects, AWS choices, trade-offs, and outcomes documented in this portfolio. If the notes are thin, I will say so.",
...
export const WORLD_HERO = {
  name: IDENTITY.name,
  role: IDENTITY.headline,
  statement: [IDENTITY.role, IDENTITY.domains],
  support: IDENTITY.statement,
};

/** Homepage landing — headline, CTAs, and proof not repeated on work cards or the map */
export const LANDING_HERO = {
  kicker: "Data engineering · Cloud · Analytics",
  titleBefore: "I build data systems that make complexity ",
  titleMark: "usable.",
  support:
    "Lead Data Engineer building reliable, scalable, cost-efficient platforms on cloud.",
  primaryCta: { href: "/projects", label: "Explore my work" },
  secondaryCta: { href: "/#ask", label: "Ask Mansi" },
};
