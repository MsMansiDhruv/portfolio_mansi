...
export const AMC_CASE_STUDY = {
  ...
  subtitle: "Modernizing legacy ETL and analytics infrastructure for a Leading Indian AMC.",
  ...
  transformation: {
    ...
    after: [
      ...
      "Navigator self-service workflows",
    ],
  },
  ...
  architecture: {
    ...
    imageAlt:
      "Layered AWS data platform for a Leading Indian AMC: ingestion, Bronze/Silver/Gold processing, Redshift, and Power BI.",
  },
  ...
  decisions: [
    ...
    },
    {
      ...
      decision: "Refactor Navigator and improve Power BI consumption.",
  ...
  outcomes: [
    ...
    {
      title: "Self-service",
      body: "Navigator improved internal data access and update workflows.",
    },
  ],
