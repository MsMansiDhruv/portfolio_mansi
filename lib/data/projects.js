...
export const PROJECTS = [
  {
    ...
    desc: "Cloud-native lake, Glue ETL, and Redshift analytics — confidential asset-management client",
    date: "2025-03",
  ...
  },
  {
    ...
    desc: "End-to-end ML allocation — eligibility, classification, and production serving on AWS",
    date: "2025-02",
    category: "Machine Learning",
    tech: ["AWS", "Databricks", "MLflow", "ECR", "GraphQL"],
    tags: ["ml", "aws", "data engineering", "architecture"],
    pinned: true,
  },
  {
    slug: "automated-intelligence-pipeline",
    title: "Automated Web Intelligence Pipeline",
    desc: "Crawlers, extraction, deduplication, and DS model integration on AWS — confidential client",
    date: "2025-01",
    category: "Data Engineering",
    tech: ["Python", "Scrapy", "Selenium", "AWS Lambda", "S3", "Terraform"],
    tags: ["data engineering", "aws", "automation", "scraping"],
    pinned: true,
  },
  {
