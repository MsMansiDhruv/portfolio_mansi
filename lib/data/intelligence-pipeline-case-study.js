...
export const INTELLIGENCE_ARCH_IMAGE = "/projects/intelligence/architecture.jpg";
...
export const INTELLIGENCE_CASE_STUDY = {
  ...
  subtitle:
    "An automated data pipeline for discovering, extracting, processing and surfacing business-relevant content from distributed web sources.",
  ...
  problem: {
    ...
    body:
      "Relevant content was distributed across inconsistent page structures and feeds. Manually monitoring sources, extracting useful information, identifying duplicates, and getting filtered results to internal teams did not scale.",
    fragments: ["RSS", "Publisher page", "Dynamic webpage", "Site-specific source"],
  ...
  sourceDiscovery: {
    ...
    approaches: [
      ...
      { title: "Generic crawler", body: "For standard publisher layouts" },
  ...
  output: {
    ...
    body: "Internal teams received filtered, relevant content — not another inbox of raw crawls.",
  },
