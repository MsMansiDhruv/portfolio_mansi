...
export const EXPERIENCE_WINDOWS = {
  void: { start: 0, end: 0.03 },
  hero: { start: 0.03, end: 0.12 },
  systems: { start: 0.12, end: 0.26 },
  pipeline: { start: 0.26, end: 0.34 },
  streams: { start: 0.34, end: 0.46 },
  city: { start: 0.46, end: 0.56 },
  projects: { start: 0.56, end: 0.74 },
  lab: { start: 0.74, end: 0.85 },
  beyond: { start: 0.85, end: 0.92 },
