...
export const EXPERIENCE_OPENING = {
  ...
  world: "A WORLD BUILT FROM CURIOSITY, EXPERIENCE & CREATION.",
...
export const EXPERIENCE_COPY = {
  curious: {
    ...
    sub: "A world built from curiosity, experience & creation",
  },
  personal: {
    headline: "ALWAYS EXPLORING.",
...
export const CINEMATIC_BACKDROPS = [
  { id: "hero", src: "/cinematic/hero-world.webp", window: [0, 0.16], opacity: 0.95 },
  { id: "world", src: "/cinematic/mansi-world.webp", window: [0.14, 0.31], opacity: 0.95 },
  { id: "personal", src: "/cinematic/personal-world.webp", window: [0.29, 0.465], opacity: 0.9 },
  { id: "engineering", src: "/cinematic/engineering-world.webp", window: [0.45, 0.665], opacity: 0.9 },
  { id: "gallery", src: "/cinematic/project-gallery.webp", window: [0.645, 0.9], opacity: 0.9 },
  // The reveal returns to the world vista — it was one world the entire time.
  { id: "reveal", src: "/cinematic/mansi-world.webp", window: [0.895, 1], opacity: 0.95 },
];
