...
export const ABOUT_ME = [
  ...
  "I build reliable data systems across cloud, ETL, and analytics—from modernizing legacy pipelines to designing architectures that balance performance, cost, and maintainability. I enjoy the messy problems behind clean dashboards: finding bottlenecks and turning complexity into infrastructure people can rely on.",
];
