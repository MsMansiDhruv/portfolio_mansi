...
export const ABOUT_ME = [
  ...
  "I like work where architecture, delivery, and operations have to hold together: lakehouse patterns, governed pipelines, and analytics surfaces teams can actually use.",
];
