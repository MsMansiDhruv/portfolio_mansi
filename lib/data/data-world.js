...
export const THEME = {
  ...
  day: {
    // High-end aluminium daylight — high-contrast grains, never cream
    id: "day",
    bg: "#F2F5F8",
    fog: "#E7ECF1",
    fogNear: 22,
    fogFar: 48,
    ink: "#111820",
    muted: "rgba(67, 81, 94, 0.92)",
    faint: "rgba(67, 81, 94, 0.7)",
    line: "rgba(103, 116, 129, 0.28)",
    surface: "#E7ECF1",
    globe: "#c8d0da",
    globeEmissive: "#b8c2ce",
    steel: "#111820",
    data: "#1a4f9c",
    transform: "#0f6563",
    infra: "#3d4a56",
