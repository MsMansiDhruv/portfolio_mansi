...
export const BRAIN_CASE_STUDY = {
  ...
  productGap: {
    ...
    annotations: [
      "Primary signup funnel emphasized one product surface",
  ...
  productionArch: {
    ...
    detailImageAlt: "Conceptual production architecture diagram.",
  },
  ...
  conclusion: {
    ...
    line1: "A model creates predictions.",
    headline: "A production system turns them into decisions.",
    supporting: "The engineering challenge was connecting the two.",
  },
};
