...
export default function GradientWaves({
  ...
  useEffect(() => {
    ...
    apply(u.uHorizonColor.value, horizonColor);
    apply(u.uWaveColor.value, waveColor);
    apply(u.uCrestColor.value, crestColor);
  }, [
    horizonColor,
    waveColor,
    crestColor,
  ...
  return <div ref={containerRef} className={`gradient-waves${className ? ` ${className}` : ""}`} aria-hidden />;
}
